...
+ 游戏的理解和解释
  ...
  2. 现代游戏理论：主要有精神分析学派理论和认知学派理论等对游戏的解释。精神分析理论着眼于游戏与儿童的人格和情绪的发展。他们认为游戏能获得现实中不能实现的愿望。通过游戏主动控制情境，以调节情绪、释放焦虑、补偿愿望。
...
+ 记忆的发展
+ 童年期的思维的发展
  1. 推理能力的发展：推理是由一个或多个判断推出一个新的判断的思维过程。小学儿童间接推理能力的发展突出表现为演绎推理发展、归纳推理发展和类比推理能力的发展。
+ 思维的基本特征
